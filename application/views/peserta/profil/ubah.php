    ...
    <div class="tab-content">
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group row">
                     ...
                     <!-- <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="minat_ps" value="<?= $peserta->minat_ps ?>">
                        </div>
                    </div>   
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="wawasan_ict" value="<?= $peserta->wawasan_ict ?>">
                        </div>
                    </div>  
                        </div>
                    </div> -->
        ...
        <div class="row justify-content-between btn-page">
            <div class="col-sm-12 text-md-right">
                <a class="btn btn-secondary" href="<?= base_url('datadiri') ?>"><i class="fas fa-undo-alt"></i> Kembali</a>
